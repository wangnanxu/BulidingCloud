...
GO
INSERT [dbo].[RFAFunctions] ([FunctionID], [Name], [MyID], [ParentID], [Desription], [Available], [UpdateTime]) VALUES (N'Root.ReportManagement.ProjectReport', N'项目统计报表', N'ProjectReport', N'Root.ReportManagement', N'项目统计报表', 1, CAST(0x0000A4C901276A75 AS DateTime))
GO
