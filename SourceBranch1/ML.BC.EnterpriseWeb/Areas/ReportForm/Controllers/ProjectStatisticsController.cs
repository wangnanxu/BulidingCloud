...
namespace ML.BC.EnterpriseWeb.Areas.ReportForm.Controllers
{
    ...
    public class ProjectStatisticsController : BCControllerBase
    {
        ...
        //todo
        [PermissionControlAttribute(Functions.Root_ReportManagement_ProjectReport)]
        public ActionResult GetProjStatData(ProjectStatisticsQueryModel model)
        {
            ...
            result.Try(() =>
            {
                ...
                int amount;
                var r = _projStatService.GetProjectStatisInfo(_user.EnterpriseID, model.ProjectName, model.rows, model.page, out amount);
                ...
                //所有项目合计footer
                int projAmount;
                ProjectStatisticsShowModel footer2 = _projStatService.GetAllProjectStatisInfo(_user.EnterpriseID,out projAmount);
                footer.projectName = "所有项目合计";
