...
//转换时间
function GetDateTime(value, row, index,fmt)
{
    if (typeof (value) == "undefined" || value == null) { return; }
    if (typeof (fmt) == "undefined" || fmt == "") fmt = "yyyy-MM-dd";

   return  ConvertDateForMillisecond(value,fmt);
}
function GetFullDateTime(value, row, index) {
 return   GetDateTime(value, row, index, 'yyyy-MM-dd HH:mm:ss')
}
//字符串到数据
