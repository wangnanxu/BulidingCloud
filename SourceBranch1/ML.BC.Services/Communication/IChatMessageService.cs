...
namespace ML.BC.Services
{
    public interface IChatMessageService
    {
        ...
        List<ChatDto> SearchChatMessages(string userId, DateTime? beginTime, DateTime? endTime, string senderName, ML.BC.EnterpriseData.Common.ReadStatus status, int pageSize, int pageNumber, out int amount);
    }
}
