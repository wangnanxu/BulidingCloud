...
(function(window, document, Math) {
	...
	var _endFun;
	var _param;
	function IScroll(el, options, direct,endfun,param) {
		_endFun=endfun;
		_param=param;
		...
		//	alert(this.scroller.clientHeight);
		var startHeight = this.wrapper.clientHeight - this.scroller.clientHeight;
		switch (direct) {
			case "up":
				if (startHeight >= 0) {
					startHeight = 0;
	...
	IScroll.prototype = {
		...
		_start: function(e) {
			...
			var point = e.touches ? e.touches[0] : e,
				pos;
			var startHeight = 0 - this.scroller.clientHeight;
			this.initiated = utils.eventType[e.type];
			this.moved = false;
			this.distX = 0;
			this.distY = startHeight
			this.directionX = 0;
			this.directionY = startHeight
		...
		_end: function(e) {
			...
			if (pullDownEl && pullDownEl.className.match('flip')) {
				...
				if(typeof(_endFun)=="function"){
					_endFun(_param);
				}
				//message_Control.SelectMessage(false); // Execute custom function (ajax call?)
