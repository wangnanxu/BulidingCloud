...
namespace ML.BC.Services
{
    public interface ISceneItemManagementService : IServiceBase
    {
        ...
        byte[] DownloadPicturePack(string sceneID);
        bool DeleteSceneItem(string sceneItemID);
        void DeleteSceneItemPicture(string sceneItemId, string orgPicName);
        bool DeleteCommentItem(string sceneItemID, Guid commentGuid, DateTime updateTime);
        bool SavePicture(Picture picture);
        bool SetSceneItemStatus(string sceneItemID, Examine examine);
        ...
        SceneItem AddCommentItem(string sceneItemID, Comment comment, Examine examine);
        ...
        void ChangeSceneItemStatus(Examine examine,string SceneItemID);
    }
}
