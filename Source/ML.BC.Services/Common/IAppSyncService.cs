...
namespace ML.BC.Services.Common
{
    public interface IAppSyncService
    {
        ...
        bool ClearSyncState(string userID, string deviceID);
        ...
        void ChangeUserMessageQueueStatus(string userId,string deviceId,DateTime? time);
        /// <summary>
        /// 判断是否超过3天未登录
        /// </summary>
        /// <param name="time"></param>
        /// <returns></returns>
        bool YesOrNo(DateTime? time);
        DateTime GetWorkerTime();
    }
}
